<header class="fixed top-0 w-full z-50 bg-black py-3 animate-swipe-down">
    <div class="max-w-6xl mx-auto px-4 flex items-center justify-between">
        ...
        <!-- Navigation Menu -->
        <nav class="peer-checked:flex hidden md:flex flex-col md:flex-row md:items-center gap-3 absolute md:static top-14 left-0 w-full md:w-auto bg-black md:bg-transparent p-4 md:p-0">
            <a href="#about">
            ...
            <a href="#blogs">
                <button class="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-white rounded-lg group focus:ring-2 focus:ring-[#b600ff] bg-gradient-to-r from-[#b600ff] to-[#4e00a4]">
                    <span class="relative px-4 py-2 md:px-5 md:py-2.5 bg-black rounded-md group-hover:bg-transparent transition-all duration-200">Blogs</span>
                </button>
            </a>
            <a href="#contact">
                <button class="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-white rounded-lg group focus:ring-2 focus:ring-[#b600ff] bg-gradient-to-r from-[#b600ff] to-[#4e00a4]">
